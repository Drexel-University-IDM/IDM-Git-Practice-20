 ...
 */
function isValid(projectName) {
    if (projectName === void 0) { projectName = null; }
    var projectRoot = './' + (projectName ? projectName + '/' : '');
...
function getConfig() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, JSON.parse(file.readText('./sheetbase.config.json'))];
        });
    });
}
...
function setConfig(configData) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, file.editJson('./sheetbase.config.json', configData)];
